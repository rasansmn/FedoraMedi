    ...
    Protected Sub btnRegister_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRegister.Click
        ...
        Else
            Try
                ...
                Dim cmdin As New SqlCommand("INSERT INTO tblLogin VALUES (" & loginid & ",'" & txtUsername.Text & "','" & core.getmd5(txtPw.Text) & "'," & 3 & ")", connection.connection)
                cmdin.ExecuteNonQuery()
                Dim cmdin2 As New SqlCommand("INSERT INTO tblHospital VALUES (" & loginid & ",'" & txtName.Text & "','" & photourl & "','" & txtAddress.Text & "','" & txtCity.Text & "','" & txtPhone.Text & "','" & txtEmail.Text & "','" & txtDetails.Text & "','" & Now.Date & "','" & Now.Date & "',0," & loginid & ")", connection.connection)
